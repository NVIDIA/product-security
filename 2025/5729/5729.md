...
NVIDIA has released a software update for NVIDIA® NeMo Framework.<br><div>To protect your system, clone or update this software to version 2.5.1 or later from NVIDIA/NeMo Framework on <a href="https://github.com/NVIDIA/NeMo/releases">NVIDIA Github</a> and <a href="https://pypi.org/project/nemo-toolkit/">pypi</a>.</div>
...
| --------------------- | --------------------- | ----------------- | --------------------- | ------------------- |
| CVE-2025-33204 | NeMo Framework | All platforms | All versions prior to 2.5.1 | 2.5.1 |
| CVE-2025-33205 | NeMo Framework | All platforms | All versions prior to 2.5.1 | 2.5.1 |
...
CVE-2025-33204: Tong Liu (IIE)

CVE-2025-33205: Peng Zhou (zpbrent) @ Shanghai University
